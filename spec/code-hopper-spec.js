...
describe('CodeHopper', () => {
  ...
  describe('when the code-hopper:toggle event is triggered', () => {
    it('hides and shows the modal panel', () => {
      // Before the activation event the view is not on the DOM, and no panel
      // has been created
      expect(workspaceElement.querySelector('.code-hopper')).not.toExist();

      // This is an activation event, triggering it will cause the package to be
      // activated.
      atom.commands.dispatch(workspaceElement, 'code-hopper:toggle');
      ...
      runs(() => {
        expect(workspaceElement.querySelector('.code-hopper')).toExist();

        let myPackageElement = workspaceElement.querySelector('.code-hopper');
